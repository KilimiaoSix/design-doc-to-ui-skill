...
def build_manifest(args: argparse.Namespace, source_text: str, pages: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "artifacts": {
            ...
            "stage_approval_style": "qa/stage-approval-style.json",
            "stage_approval_interaction_design": "qa/stage-approval-interaction-design.json",
            "stage_approval_ai_design_images": "qa/stage-approval-ai-design-images.json",
            "stage_approval_design_doc": "qa/stage-approval-design-doc.json",
            "stage_approval_feishu_doc": "qa/stage-approval-feishu-doc.json",
            ...
            "feishu_doc_content_audit": "qa/feishu-doc-content-audit.json",
            ...
            "react_usability_audit": "prototype/qa/react-usability-audit.json",
        ...
        "phase_status": {
            ...
            "style_user_approved": False,
            "interaction_design_user_approved": False,
            "ai_design_images_user_approved": False,
            "design_doc_user_approved": False,
            "feishu_doc_user_approved": False,
            "feishu_doc_content_verified": False,
            "react_allowed": False,
            "html_allowed": False,
            ...
            "react_usability_audit_passed": False,
            "react_worker_passed": False,
            "react_interaction_audit_passed": False,
            "global_navigation_passed": False,
            "react_scroll_behavior_passed": False,
            "react_demo_page_switcher_passed": False,
